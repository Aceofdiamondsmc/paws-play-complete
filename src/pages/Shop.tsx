            ...
            options: {
              product: {
                styles: {
                  ...
                  title: { color: "hsl(25 30% 15%)" },
                  button: {
                    ":hover": { "background-color": "#ce815b" },
                    "background-color": "#e58f65",
                    ":focus": { "background-color": "#ce815b" },
                    "border-radius": "9999px"
                  },
                  price: { color: "hsl(25 30% 15%)" }
                },
              ...
              modalProduct: {
                ...
                styles: {
                  ...
                  title: { "font-family": "Nunito, sans-serif", "font-weight": "bold", "font-size": "26px" }
                },
                text: { button: "Add to cart" }
              },
              modal: {
                styles: { modal: { "background-color": "hsl(150 25% 85%)" } }
              },
              cart: {
                styles: {
                  button: {
                  ...
                  cart: { "background-color": "hsl(45 30% 98%)" },
                  footer: { "background-color": "hsl(45 30% 98%)" }
                },
                text: {
                  total: "Subtotal",
    ...
    <div className="min-h-screen">
      ...
      <div className="bg-card/95 backdrop-blur border-b border-border p-4">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Exclusive gear for you and your pup
        </p>
      </div>
